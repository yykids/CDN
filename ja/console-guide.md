...
- **サービス**
 サービスする地域を選択します。
サービス提供形態に応じて、KOREAまたはGLOBALを選択できます。各国に存在するキャッシュサーバーを利用して全世界を対象にサービスするにはGLOBALを選択し、韓国内でのみサービスするにはKOREAを選択します。 KOREAを選択した場合、さらに安い価格でサービスを利用できます。
...
3. **確認**ボタンをクリックすると、CDNサービスの作成要求が完了します。
